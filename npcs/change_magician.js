...
/**
 * Magician Job Instructor (NPC 1072001)
 * Victoria Road: The Forest North of Ellinia (Map 101020000)
 *
...
if (player.hasItem(4031009, 1) && player.hasItem(4031013, 0)) {
npc.sayNext("Hmmm...it is definitely the letter from #b#p1032001##k...so you came all the way here to take the test and make the 2nd job advancement as the magician. Alright, I'll explain the test to you. Don't sweat it much, though; it's not that complicated.");
        ...
        if (selection == 0) {
npc.sayNext("I don't think you are prepared for this. Talk to me when you make yourself much more ready for this. There are neither portals nor stores inside, so you better get ready for it all the way.");
        } else if (selection == 1) {
npc.sayNext("Alright, I'll let you in! Once you go in, defeat the monsters and collect 30 Dark Marbles. After that go talk to my colleague inside to receive #b#t4031012##k as proof that you have passed the test. Best of luck to you.");
        ...
        npc.makeEvent("change_job", false, [player, 108000201]);
        }
} else if (player.hasItem(4031009, 1) && player.hasItem(4031013, 1)) {
...
npc.sayNext("Do you want to be a stronger magician? Let me take care of that for you, then. You look definitely qualified for it. For now, go see #b#p1032001##k of Ellinia first.");
}