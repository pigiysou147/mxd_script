...
var itemtk1 = Array( //认证的写这里 然后每日奖励 请看下面第99行
	Array("小蘑菇"),
	Array("灶门祢豆子"),
	Array("你的时光"),
...
var selStr = "   #e#r" + tz14 + "『女生认证福利』" + tz14 + "\r\n";
...
selStr += "  #n#d#L1#" + tz10 + "女生每日福利[认证请联系GM]#l\r\n";
selStr += "  #n#d#L4#" + tz10 + "领取认证勋章#l\r\n";
selStr += "  #d#L5#" + tz10 + "查看已认证的的女生#l\r\n\r\n";
selStr += "    " + nu2 + "     " + nu2 + "\r\n";
...
switch(selection) {
	case 1:
		if(getEventCount("女生奖励") < 1) {
			...
			if(ssss == 1) {
				...
				addHyPay(-10);
				npc.broadcastPlayerNotice(0x15, "『女神福利』" + " : " + "女生认证玩家 " + player.getName() + " 成功领取每日女生福利.");
				npc.broadcastPlayerNotice(0x15,"【女神红包】：恭喜玩家 " + player.getName() + " 领取女神认证每日福利 " + 10 + " 余额。");
	...
	case 4:
		if(getEventCount("女生勋章发放") == 0) {
			...
			npc.say("领取失败！你已经领取过，或者你还没有认证！有问题请联系GM认证！");
		}
		break;
