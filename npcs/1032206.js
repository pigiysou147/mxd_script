...
// 	if (count%100==0){
// 		npc.broadcastWeatherEffectNotice(37, "[抢楼活动]： 玩家 " + player.getName() + " 在抢楼活动抢到"+count+"楼啦，抢楼地点在1楼教室佩妮处~~各位玩家快来参与吧", 10000);
// 		npc.broadcastNotice("[抢楼活动]： 玩家 " + player.getName() + " 在抢楼活动抢到"+count+"楼啦，抢楼地点在1楼教室佩妮处~~各位玩家快来参与吧");
