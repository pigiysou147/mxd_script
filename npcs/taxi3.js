...
/**
 * Regular Cab (NPC 1052016)
 * Victoria Road: Kerning City (Map 103000000)
 *
 * Taxi NPC for Kerning City. Teleports players from Henesys to other Victoria
 * Island towns.
 *
 * @author Jackson (content from Vana r3171)
 */

let taxiMaps = [104000000, 102000000, 101000000, 100000000, 120000000];
let taxiFares = [1000, 800, 1200, 1000, 1000];
...
npc.sayNext("Hi! I drive the #p1052016#. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination with an affordable price.");
let prompt;
if (player.getJob() == 0) {
