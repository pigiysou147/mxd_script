...
// if(event != null && event.getVariable("state").equals("1")) {
...
// 	if (count%100==0){
// 		npc.broadcastWeatherEffectNotice(37, "[抢楼活动]： 玩家 " + player.getName() + " 在抢楼活动抢到"+count+"楼啦，抢楼地点在一线童话村厕所门口处~~各位玩家快来参与吧", 10000);
// 		npc.broadcastNotice("[抢楼活动]： 玩家 " + player.getName() + " 在抢楼活动抢到"+count+"楼啦，抢楼地点在一线童话村厕所门口处~~各位玩家快来参与吧");
...
// 		npc.broadcastNotice("[抢楼活动]： 恭喜玩家 " + player.getName() + " 在抢楼活动中获得一等奖 获得 8888 点卷 .真让人羡慕");
// 		npc.say("[抢楼活动] 恭喜你获得了抢楼活动一等奖。获得 8888 点卷奖励");
// 	} else if(count > max && count <= (max + 10)) {
// 		player.modifyCashShopCurrency(1, dj);
// 		player.gainItem(2430069, 2); //工匠之魔方
// 		player.gainMesos(3000000);
// 		player.gainExp(350000000);
// 		npc.broadcastNotice("[抢楼活动]： 恭喜玩家 " + player.getName() + " 在抢楼活动中获得二等奖 获得 6888 点卷 .真让人羡慕");
// 		npc.say("恭喜你获得了抢楼活动二等奖。获得 6888 点卷奖励");
// 	} else if(count > (max + 10) && count <= (max + 15)) {
// 		player.modifyCashShopCurrency(1, dj3);
// 		player.gainItem(2430069, 1); //工匠之魔方
// 		player.gainMesos(3000000);
// 		player.gainExp(350000000);
// 		npc.broadcastNotice("[抢楼活动]： 恭喜玩家 " + player.getName() + " 在抢楼活动中获得三等奖 " + dj3 + "点卷.本次抢楼活动已经结束...");
// 		npc.say("恭喜你获得了抢楼活动三等奖. 获得 3888 点卷奖励\r\n本次抢楼活动已经结束...");
