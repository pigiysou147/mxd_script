...
let type = 5220040;// 1=點券 2=抵用 3=金幣 4=余額 物品ID=材料抽獎
let needNum = 1;//需要數量
let title = "";
let haveMoney = 0;
...
let items = Array(
	...
	Array(2630230,1,1),//1288  AD圖騰

	Array(2431339,1,10),//168歡樂

	//小獎
	Array(2437178,1,100),//AP寶石
	Array(4430000,1,50),//AP寶石
	Array(4310205,25,100),//星星包
	Array(2433442,1,60),//神秘武器
	Array(2435718,1,80),//星岩
	Array(4036313,10,100),//賞金金幣
	Array(2433028,1,100),//銀河副武自選
	Array(2435153,1,100),//星力強化箱
	Array(4000038,5,60),//金盃
	Array(2434666,1,50),//蠟筆自選
	Array(2430791,1,40),//全屬+100
	Array(2434622,1,20),//星星包
	...
	Array(2435824,1,49),//v自選
	Array(2438458,1,49),//黑自選
