...
while (true) {
        let selection = npc.askMenu("Now...ask me any questions you may have on traveling!!\r\n#b"
                + "#L0#How do I move?#l\r\n"
        ...
        switch (selection) {
                case 0:
                        npc.sayNext("Alright this is how you move. Use #bleft, right arrow#k to move around the flatland and slanted roads, and press #bAlt#k to jump. A select number of shoes improve your speed and jumping abilities.");
                        break;
                case 1:
                        ...
                        npc.sayNext("Once you make the job advancement, you'll acquire different kinds of skills, and you can assign them to HotKeys for easier access. If it's an attacking skill, you don't need to press Ctrl to attack; just press the button assigned as a HotKey.");
                        break;
                case 2:
                        ...
                        npc.sayNext("Remember, though, that if your item inventory is full, you won't be able to acquire more. So if you have an item you don't need, sell it so you can make something out of it. The inventory may expand once you make the job advancement.");
                        break;
                case 3:
                        ...
                        npc.sayNext("There isn't much to lose when you die if you are just a beginner. Once you have a job, however, it's a different story. You'll lose a portion of your EXP when you die, so make sure you avoid danger and death at all cost.");
                        break;
                case 4:
                ...
                case 5:
                        ...
                        npc.sayNext("How do you get to Victoria Island? On the east of this island there's an harbor called #m60000#. There, you'll find a ship that flies in the air. In front of the ship stands the captain. Ask him about it.");
                        npc.sayNext("Oh yeah! One last piece of information before I go. If you are not sure where you are, always press #bW#k. The world map will pop up with the locator showing where you stand. You won't have to worry about getting lost with that.");
                        break;
                case 6:
                ...
                case 9:
                        ...
                        npc.sayNext("Oh by the way, unlike other jobs, to become magician you only need to be at level 8. What comes with making the job advancement early also comes with the fact that it takes a lot to become a true powerful mage. Think long and carefully before choosing your path.");
                        break;
                case 10:
                        npc.sayNext("Do you wish to become a #bPirate#k? In order to make a job advancement, you MUST head to Victoria Island. Head to the #bNautilus#k, a strange-looking submarine currently docked on the island, head inside, and find #bKyrin#k. She'll help you with the rest.");
                        npc.sayNext("By the way! Don't forget you have to be over level 10 and over 20 DEX to become a pirate!!");
                        break;
                case 11:
                        npc.sayNext("You want to know how to raise your character's ability stats? First press S to check out the ability window. Every time you level up, you'll be awarded 5 ability points aka AP's. Assign those AP's to the ability of your choice. It's that simple.");
                        npc.sayNext("Place your mouse cursor on top of all abilities for a brief explanation. For example, STR for warriors, DEX for bowman, INT for magician, and LUK for thief. That itself isn't everything you need to know, so you'll need to think long and hard on how to emphasize your character's strengths through assigning the points.");
                        break;
                case 12:
                        npc.sayNext("You want to know how to check out the items you've picked up, huh? When you defeat a monster, it'll drop an item on the ground, and you may press Z to pick up the item. That item will then be stored in your item inventory, and you can take a look at it by simply press I.");
                        break;
                case 13:
                        ...
                        break;
                case 14:
                        npc.sayNext("You want to check on the equipped items, right? Press E to open the equipment inventory, where you'll see exactly what you are wearing right at that moment. To take off an item, double-click on the item. The item will then be sent to the item inventory.");
                        break;
                case 15:
                        npc.sayNext("The special 'abilities' you get after acquiring a job are called skills. You'll acquire skills that are specifically for that job. You're not at that stage yet, so you don't have any skills yet, but just remember that to check on your skills, press K to open the skill book. It'll help you down the road.");
                        break;
                case 16:
                        ...
                        break;
                case 17:
                        npc.sayNext("It's the currency used in MapleStory. You may purchase items through mesos. To earn them, you may either defeat the monsters, sell items at the store, or complete quests..");
                        break;
        }
}