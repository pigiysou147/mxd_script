...
if (map.getId() == startmap) {
        ...
        for (let i = 0; i < BossName.length; i++) {
                text += "\r\n#b#L" + i + "#前往临尽之地(" + BossName[i] + ")#l#k";
        }
        let sel = npc.askMenuE("#k必须要阻止亲卫队长敦凯尔和他的亲卫队。.#b" + text, true);
        ...
        let ret = npc.askYesNoE("#e<Boss：敦凯尔>#n\r\n\r\n你想要现在就离开这里吗？", true);
        if (ret == 1) {
                player.changeMap(450012200);
        }
}
