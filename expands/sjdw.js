...
var a = 0;
var selStr = "#d把#z1190400#取下放背包，请选择当前需要晋级的符号：#n#k\r\n";
selStr += "#e#r#L0#" + zs1 + "晋级到『#z1190401#』#k#d全属性+10#l#n\r\n\r\n";
selStr += "#e#r#L1#" + zs1 + "晋级到『#z1190402#』#k#d全属性+20#l#n\r\n\r\n";
selStr += "#e#r#L2#" + zs1 + "晋级到『#z1190405#』#k#d全属性+35#l#n\r\n\r\n";
selStr += "#e#r#L3#" + zs1 + "晋级到『#z1190407#』#k#d全属性+40#l#n\r\n\r\n";
selStr += "#e#r#L4#" + zs1 + "晋级到『#z1190301#』#k#d全属性+50\r\n    BOSS伤害+30  无视防御+30#l#n\r\n\r\n";
let selection =npc.askMenuS(selStr);
switch(selection) {
	case 0:

		player.runScript("fuhao1");
		break;
	case 1:

		player.runScript("fuhao2");
		break;
	case 2:

		player.runScript("fuhao3");
		break;
	case 3:

		player.runScript("fuhao4");
		break;
	case 4:

		player.runScript("fuhao5");
		break;
}