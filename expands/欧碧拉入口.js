...
text += "\r\n#b#L0#开始挑战材料boss<简单>！(剩余 #r"+(maxenter-getEventCount("wxhl4"))+" #b次)#b#l#k";
let sel = npc.askMenu("#e<单人材料BOSS挑战>#n\r\n\r\n#b#h0# \n\#k准备好迎接挑战吧！#b\r\n" + text, npcModal);
...
if(item==null){
	...
	}else if(maxenter-getEventCount("wxhl4")<1){
		npc.say("当天进入次数已满");
	}else if(!player.hasMesos(30000000) ){
		npc.say("需要3000W金币");
	}else if (npc.makeEvent("wxhl4", true, [player,sel]) == null) {
