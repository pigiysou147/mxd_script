...
text+="#k\r\n\r\n";
text+="#r#e固定赠送#v2614068# X 4 #v2431142# X1 #v4001118# X20 \r\n\r\n（突破超过100E,则会直接给予10倍突破加在武器上）\r\n";
...
if(sel==1){
	if(player.getFreeSlots(3) < 5) {
		...
		player.gainItem(2431142,1);
		player.gainItem(4001118,20);
		
		if(wq.getLimitBreak()>=10000000000){
			wq.setLimitBreak(wq.getLimitBreak()+1200000000);
			player.updateItem(-11,wq);
		}else{
			//给突破石头5000W
			player.gainItem(2614068,4);
