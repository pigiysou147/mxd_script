...
// 每个阶段礼包所需的充值数
var condition = new Array(571, 1428,2855,5712,8570,17140,42857);
// 礼包内容
**var reward = new Array(
    Array(
        // 礼包1 200元
        Array(2431041, 1),//赌狗
        Array(2614078, 10),//500万突破
        Array(4031997, 200),//蘑菇金币
        Array(4023025, 1),//金火
        Array(4023026, 2),//紫火
        Array(4033911, 1),//时间流动瓶子
    ...
    Array(
        // 礼包2 500元
        Array(2431041, 1),//赌狗
        Array(2614078, 30),//500万突破
        Array(4031997, 500),//蘑菇金币
        Array(4023025, 2),//金火
        Array(4023026, 5),//紫火
        Array(4033911, 2),//时间流动瓶子
	...
	Array(
        // 礼包5 3000元
        Array(2431041, 5),//赌狗
        Array(2614078, 180),//500万突破
        Array(4023026, 35),//紫火
        Array(4023025, 15),//金火
        Array(4031997, 3000),//蘑菇金币
        Array(4001332, 2),//紫色蜡笔
        Array(4033911, 15),//时间流动瓶子
        Array(4033298, 30)
	...
	Array(
        // 礼包6 6000元
        Array(2431041, 10),//赌狗
        Array(2614078, 400),//500万突破
        Array(4023026, 80),//紫火
        Array(4023025, 35),//金火
        Array(4031997, 6000),//蘑菇金币
        Array(4001332, 4),//紫色蜡笔
	...
	Array(
        // 礼包7 15000元
        Array(2431041, 20),//赌狗
        Array(2614078, 1000),//500万突破
        Array(4023026, 200),//紫火
        Array(4036457, 38),//黑火
        Array(4031997, 6000),//蘑菇金币
        Array(4001332, 8),//紫色蜡笔
        Array(4033911, 60),//时间流动瓶子
...
var xiangou = new Array(3,3,3,2,2,2,2);

revenue = parseInt(getHyPay(1));
text = "\t\t\t    #v4001449##e端午粽子礼包#k#n#v4001449# \r\n\r\n";
...
for(var i = 0; i < condition.length ; i++) {
    if(getEventCount("duanwulibao" + (i+1)) >= xiangou[i]) {
        txt = "[#r已购买最大值#d]";
    } else {
    ...
    text += "#d#L" + i + "#" + tt + txt + " 端午粽子礼包"+(i+1)+" #r\t\t" + parseInt(condition[i]*0.35+1) + "#l\r\n\r\n\r\n";
    ...
    text+="#b本周全服累计售出数量为:#k#r";
	text+=count+"#k\r\n";
    text += fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + fenge + "\r\n"
}
text += "#k";
let selection = npc.askMenu(text);
text = "\t\t\t#e#r- 端午粽子礼包" + parseInt(condition[selection]*0.35+1) + "元福利 -#k#n\r\n\r\n";
for(var i = 0; i < reward[selection].length; i++) {
    text += "\t\t#i" + reward[selection][i][0] + "# #e#r#z" + reward[selection][i][0] + "#[" + reward[selection][i][1] + "个]#k";
...
if(1==1 ){
    if(sel == 1) {
        if(getEventCount("duanwulibao" + (selection+1)) >=xiangou[selection]) {
            npc.say("#e#r\r\n\r\n\t\t这个礼包您已经购买到最大值了");
            ...
            setEventCount("duanwulibao" + (selection+1), 0, 1);
...
function getcountList(){	//														570, 1428, 2857, 5394, 8251,11108
    var sql="select event,sum(value) total from accounts_event where `event` in('duanwulibao1','duanwulibao2','duanwulibao3','duanwulibao4','duanwulibao5','duanwulibao6','duanwulibao7') GROUP BY event";
