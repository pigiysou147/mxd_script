var text = "";
text = "\t\t\t\t\t[国庆充值排行榜]\r\n";
text += "·该充值排行榜只统计2020年10月1号0点开始到2020年10月11号晚上12点截止.\r\n";

var 勋章 = "#fCharacter/Accessory/01143012.img/info/icon#"
text = "      " + 勋章 + " #r回忆岛 #b/ #b圣诞元旦充值排行榜" + 勋章 + "\r\n\r\n";
...
//等级排行
	var sql = "SELECT * FROM hypay where paihangbang>0 ORDER BY paihangbang  DESC LIMIT 180";
