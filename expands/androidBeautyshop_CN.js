...
if (player.hasAndroid()) {
        ...
        switch (selection) {
                ...
                case 1:
                        ...
                        let hairNumber=npc.askNumber("请输入发型代码:(请不要胡乱输入，以防BUG)",'20000',20000,70000);
                        
                                cHair.push(hairNumber);
                ...
                case 2:
                        ...
                        break;
                case 3:
                        //Face = getFaceStyleChoices(player.getAndroidFace());
                        let faceNumber=npc.askNumber("请输入脸型代码:(请不要胡乱输入，以防BUG)",'20000',20000,70000);
                        
                                cFace.push(faceNumber);
...
function getHairStyleChoices(currentHair) {
        ...
        for (let i = 0; i < hairs.length; i++) {
                if (npc.isHairValid(hairs[i] + color)) {
