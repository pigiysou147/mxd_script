...
itemList = player.customSqlResult("select jiezhi,need from n_jiezhi ");
var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好，请选择您希望购买的道具：";
for(var i = 0; i < itemList.size(); i++) {
	selStr += "\r\n#L" + i + "##i" + itemList.get(i).get("jiezhi") + ":# #b#t" + itemList.get(i).get("jiezhi") + "##k   #r" + itemList.get(i).get("need") + "#k点卷#l";
}
let selection = npc.askMenuS(selStr);

var item = itemList.get(selection);
selectedItem = item.get("jiezhi");
selectedCost = item.get("need");
