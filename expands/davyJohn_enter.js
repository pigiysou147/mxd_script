...
var questID = 1204;
            ...
            sel = selection;
            if (map.getId() == 910002000 && selection == 0) {
                npc.sayNext("如果你要挑战一下，我就会指引你到港口……");
				//npc.rememberMap("MULUNG_TC"); // not sure if correct..?
               ...
               /* } else if (!cm.isAllPartyMembersNotCoolDown(questID, 1300000)) {//判断组队成员是否l冷却..
                    npc.say("你的队员#r#e \"" + cm.getIsInCoolDownMemberName(questID, 1300000) + "\" #k#n目前处于等待重置时间状态。");
                     */
