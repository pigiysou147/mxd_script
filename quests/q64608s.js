...
npc.sayNextENoEsc("#b埃尔宾！", true);
npc.sayNextENoEsc("#face2##h0#~你是来表示感谢的吧？呼，我能帮助你我很开心。", 9400921);
npc.sayNextENoEsc("#b没错，谢谢你让我来到了这里。", true);
let sel = npc.askMenuENoEsc("#b所以说……我觉得如果以后装修房屋的事情也能和埃尔宾一起完成，那就太好了。\r\n#b#L0# 请你成为我的管家。#l\r\n#L1#今后我们一起好好相处吧。#l\r\n#r(※只能雇佣1名管家，雇佣后可以通过管家菜单进行变更。)#l", true);
if (sel == 0) {
        npc.sayNextENoEsc("#face1#管家？管家？嗯……听起来倒是很有趣，你会给我报酬的吧？ ", 9400921);
        npc.sayNextENoEsc("#face2#这样啊，好的！那我就答应你吧，#h0#。", 9400921);
        npc.sayNextENoEsc("#face1#对了，这是给#h0#的礼物！因为你说想要用高级的家装饰，我就准备了这个。它还有很厉害的功能，你可别被吓到了哦！ ", 9400921);
        ...
        npc.sayNextENoEsc("#face2##h0#嗯！肯定会好好相处的啦。", 9400921);
}
