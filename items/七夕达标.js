...
if(sel==1){
	if(getEventCount("qixi" + (selection+1)) >=xiangou[selection]) {
		...
		npc.broadcastWeatherEffectNotice(2,"恭喜玩家"+player.getName()+"购买了价值"+parseInt(condition[selection])+" 圣诞元旦欢乐购礼包，掌声送给土豪！！！",10000);
		npc.broadcastPlayerNotice(1,"恭喜玩家"+player.getName()+"购买了价值"+parseInt(condition[selection])+" 圣诞元旦欢乐购礼包，掌声送给土豪！！！");
		npc.broadcastPlayerNotice(2,"恭喜玩家"+player.getName()+"购买了价值"+parseInt(condition[selection])+" 圣诞元旦欢乐购礼包，掌声送给土豪！！！");
		npc.broadcastPlayerNotice(3,"恭喜玩家"+player.getName()+"购买了价值"+parseInt(condition[selection])+" 圣诞元旦欢乐购礼包，掌声送给土豪！！！");
		npc.say("领取成功");
	}
}
