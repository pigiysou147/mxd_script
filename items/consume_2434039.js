...
**/
let boxId = 2434039;//箱子ID

let equips = Array(
	//词条 0不要动 装备ID 装备名 四围 攻击力 BOSS 所属 无视 是否上锁1上0不上
    Array("全属性+100 战斗机器人（男）",0,1662073,"土豪专属",100,100,0,0,0,0),
    Array("全属性+100 战斗机器人（女）",0,1662072,"土豪专属",100,100,0,0,0,0)
);
...
if(YN == 1){
	...
	if(!player.canGainItem(1004234,1)){
		...
		newItem.setOption(1, 42087, false);
		newItem.setOption(2, 42087, false);
		newItem.setOption(3, 42087, false);
		newItem.setOption(1, 42087, true);
		newItem.setOption(2, 42087, true);
		newItem.setOption(3, 42087, true);
