...
let num = player.getAmountOfItem(2434551)
//送的物品
let newerItems = Array(
		Array(2430656,1*num),   //寶石箱子
		Array(4310104,5*num),   //rp
		Array(4310205,250*num)   //AP
);
...
let YN = npc.askYesNo("#b是否開啟#r麒麟禮包？#b"+ss);
if(YN == 1){
