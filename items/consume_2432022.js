...
if (player.isGm()) {
  txt += "GM功能：#L100097#装备更换#l#L100099#装备换型#l#L100098#改装备属性#l#L100011#全服福利#l\r\n"
}
txt += "\r\n";
txt += "\r\n";
...
switch (selection) {
  ...
  case 100099:
    if (player.isGm()) {
      player.runScript("装备换型")
    }
    break;
  case 100098:
    if (player.isGm()) {
      player.runScript("GM使用装备属性修改")
    }
    break;

  case 100097:
    if (player.isGm()) {
      player.runScript("装备更换")
    }
    break;
  case 100011:
    player.runScript("全服奖励")
    break;
}
