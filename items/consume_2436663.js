...
var Random = Math.floor(Math.random() * 5000000 + 500000);
player.loseItem(2436663,1)
player.gainMesos(Random)
player.scriptProgressMessage("恭喜你開啟『銀製錢幣』獲得了"+Random+"楓幣");
if(Random >= 5300000){
npc.broadcastPlayerNotice(37,"【金幣副本】：恭喜玩家 " + player.getName() + " 開啟『銀製錢幣』獲得了 " + Random + " 楓幣。");
}
