...
let num = player.getAmountOfItem(2434547)
//送的物品
let newerItems = Array(
		Array(2431189,1*num),   //粉末箱
		Array(4310104,1*num),   //rp
		Array(4310205,50*num)   //AP
);
...
let YN = npc.askYesNo("#b是否開啟#r青龍禮包？#b"+ss);
if(YN == 1){
