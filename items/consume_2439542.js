...
Array(5220040,50), //冒險島轉蛋券 
Array(2438458,25) //冒險島轉蛋券 
);

let Dq = 0;//點券數量
let Dy = 0;//抵用數量
let YE = 0;//餘額數量
let Meso = 800000000;//金幣數量
let boxId = 2439542;//箱子ID
...
let YN = npc.askYesNo("#b是否開啟#r累積180000餘額的贊助禮包？#b"+ss);
if(YN == 1){
