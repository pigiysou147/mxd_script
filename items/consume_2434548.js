...
let num = player.getAmountOfItem(2434548)
//送的物品
let newerItems = Array(
		Array(2430638,1*num),   //寶石箱子
		Array(4310104,2*num),   //rp
		Array(4310205,100*num)   //AP
);
...
let YN = npc.askYesNo("#b是否開啟#r白虎禮包？#b"+ss);
if(YN == 1){
