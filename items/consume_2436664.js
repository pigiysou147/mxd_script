...
var Random = Math.floor(Math.random() * 15000000 + 5000000);
player.loseItem(2436664,1)
player.gainMesos(Random)
player.scriptProgressMessage("恭喜你開啟『金製錢幣』獲得了"+Random+"楓幣");
if(Random >= 19000000){
npc.broadcastPlayerNotice(37,"【金幣副本】：恭喜玩家 " + player.getName() + " 開啟『金製錢幣』獲得了 " + Random + " 楓幣。");
}
