...
var potList = Array(
		...
		Array(40557, "技能CD-2秒",1),
		Array(40650, "金幣掉落20%",1),
		Array(40656, "物品掉落20%",1)
	...
	if(PD == 0){
		...
		if(YN == 1){
			...
			if(YN == 1){
				...
				//npc.broadcastGachaponMsgEx("『超級星星包』:【"+player.getName()+"】 使用了【超級星星包】上了自選一鍵六條["+potList[selectedPot][1]+"]屬性淺能",toDrop);
