...
Array(5062024,45),//閃炫魔方
Array(5062500,45), //大師附加神奇魔方
Array(2048749,90),//永遠的涅槃星火
Array(2049518,18),//完美刻印之印
Array(2048306,18), //特殊附加潛能附加捲
Array(5220040,18) //冒險島轉蛋券 
);

let Dq = 0;//點券數量
let Dy = 0;//抵用數量
let YE = 0;//餘額數量
let Meso = 450000000;//金幣數量
let boxId = 2439535;//箱子ID
...
let YN = npc.askYesNo("#b是否開啟#r累積50000餘額的贊助禮包？#b"+ss);
if(YN == 1){
