...
let num = player.getAmountOfItem(2434550)
//送的物品
let newerItems = Array(
		Array(2430640,1*num),   //寶石箱子
		Array(4310104,4*num),   //rp
		Array(4310205,200*num)   //AP
);
...
let YN = npc.askYesNo("#b是否開啟#r玄武禮包？#b"+ss);
if(YN == 1){
