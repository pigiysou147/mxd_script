...
Array(5220040,40), //冒險島轉蛋券 
Array(2438458,15) //冒險島轉蛋券 
);

let Dq = 0;//點券數量
let Dy = 0;//抵用數量
let YE = 0;//餘額數量
let Meso = 700000000;//金幣數量
let boxId = 2439540;//箱子ID
...
let YN = npc.askYesNo("#b是否開啟#r累積120000餘額的贊助禮包？#b"+ss);
if(YN == 1){
