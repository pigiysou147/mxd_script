...
Array(2048749,40),//永遠的涅槃星火
Array(2049518,8),//完美刻印之印
Array(2048306,8), //特殊附加潛能附加捲
Array(5220040,8) //冒險島轉蛋券 
);

let Dq = 0;//點券數量
let Dy = 0;//抵用數量
let YE = 0;//餘額數量
let Meso = 200000000;//金幣數量
let boxId = 2439530;//箱子ID
...
let YN = npc.askYesNo("#b是否開啟#r累積5000餘額的贊助禮包？#b"+ss);
if(YN == 1){
