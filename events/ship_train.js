...
let orbisStation, ludiStation,
        toOrbisWait, toLudiWait,
        toOrbis, toLudi;
...
function init(attachment) {
        ...
        orbisStation = event.getMap(200000121);
        ludiStation = event.getMap(220000110);

        toOrbisWait = event.getMap(220000111);
        toLudiWait = event.getMap(200000122);

        toOrbis = event.getMap(200090110);
        toLudi = event.getMap(200090100);
}
