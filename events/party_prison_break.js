...
let STAGE_1 = 921160100;
let STAGE_2 = 921160200;
let STAGE_3 = 921160300;
let STAGE_3_1 = 921160310;
let STAGE_3_2 = 921160320;
let STAGE_3_3 = 921160330;
let STAGE_3_4 = 921160340;
let STAGE_3_5 = 921160350;
let STAGE_4 = 921160400;
let STAGE_5 = 921160500;
let STAGE_6 = 921160600;
let STAGE_7 = 921160700;
//revivemap
//240080040  240080050
...
function init(attachment) {
        ...
        /*for (let i = 0; i < 6; i++) {
         event.setVariable("m" + i, "miro" + parseInt(Math.random() * 4));
         }*/
        ...
        for (let i = 0; i < members.length; i++) {
                ...
                members[i].addPQLog("prison_break");
        }
}
...
function playerChangedMap(player, destination) {
        ...
        switch (destination.getId()) {
                ...
                case STAGE_6:
                case STAGE_7:
                        let stage = parseInt((destination.getId() - 921160000) / 100) - 1;
...
function deinit() {
        ...
        if (entId != null) {
                event.getMap(STAGE_6).destroyTempNpc(entId);
        }
        for (let i = 0; i < members.length; i++)
                members[i].setEvent(null);
