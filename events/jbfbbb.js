...
function mobDied(mob) {
    if(map.getEventMobCount()==0){
		//结算金币
		beilv=getBl();
		player.gainMesos(beilv*500000);
		totalMeso+=beilv*500000;
		player.dropMessage(1,"本次获得金币: "+(beilv*500000)/10000+" W 累计获得金币:  "+parseInt(totalMeso/100000000)+" E ");
