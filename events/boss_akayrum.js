...
let FIELD_1 = 272020210;
let FIELD_2 = 272020310;
let FIELD_3 = 272020410;
let party;
let members;
let endTime;
let DEATH_COUNT = 5;
let BOSS_LOG = "Akayrum";
var total=0;
function init(attachment) {
        ...
        /*
         ...
         break1
         */
        event.getMap(FIELD_1).blowWeather(5120043, "分不清勇气和蛮勇的人，不怕死就来吧，呵呵。");
...
function mobHit(player, mob, damage) {
		total+=damage;
        player.dropMessage(1,"mob : "+ mob.getDataId() +" 本次伤害："+(damage/100000000)+" 总计伤害:"+(total/10));
}
